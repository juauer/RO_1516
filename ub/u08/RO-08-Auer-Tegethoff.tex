...
Natürlich ist die Variante implementiert, die Kreise ausschließt. Anstatt eine Liste (mit teuren Operationen) zu verwalten, arbeitet der Algo aber auf einem 2D-Array in dem der \emph{CLOSED}-Status als Zustand für jede Zelle gehalten werden kann. Die \emph{OPEN}-Priority-Queue enthält Zeiger  auf diese Zellen. Ansonsten ist A* konventionell implementiert.
